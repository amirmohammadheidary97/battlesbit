...
const LevelSection = () => (
  <Grid size={12} container p={'1rem'} justifyContent={'space-between'} alignItems={'center'} bgcolor={'background.paper'} sx={{borderRadius: theme => theme.shape.borderRadius , height: '9.78125rem'}}>
